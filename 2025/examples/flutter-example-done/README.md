...
Репозиторий буткемпа мобильной и кроссплатформенной разработки **Студенческой ИТ-лаборатории** по направлению "Flutter". В репозитории находится **полностью готовый** проект, который на буткемпе был собран под Android (и даже Windows).
